...
const pizza =
{
    ...
    popularity: 1,
    rating: 6,
    tags: ['Party Pleaser', 'Classic', 'Kids']
}
...
[
    ...
    },
    {
        ...
        popularity: 1,
        rating: 9,
        tags: ['Party Pleaser', 'Kids', 'gluten free']
    },
    {
        name: 'veggie',
        price: 12.25,
...
const filteredFood = foodArr.filter(function(arr) 
{
    for(let i = 0; i < arr.tags.length; i++)
    {
        if (arr.tags[i] === 'Classic')
        {
            return arr
        }
    }
